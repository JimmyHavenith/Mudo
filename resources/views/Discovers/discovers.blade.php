@extends ('layout')
@section('title', 'Résultats de Discover' )
@section('mainContent')
  <div class="page-discovers-title">
    <div class="movie-discovers container">
      <img src="../img/binoculars.png" alt="" class="col-md-2 result-discover-img"/>
      <h2 class="col-md-7 movie-results-title"><span class="discovers-title">Résultats de votre recherche avec Discover</span></h2>
    </div>
  </div>
  <div class="page-watchlist">
    <div class="movies-result container favorites">
      <ul>
        @forelse($discover as $key => $value)
