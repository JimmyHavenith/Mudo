      ...
      <div class="banner">
        <div class="banner-img">
          <a title="Accéder à la fiche technique du film Warcraft" href="/movies/68735-warcraft">
            <img width="100%" height="auto" src="img/banner-warcraft.png" alt="Affiche du film Warcraft" />
          </a>
        </div>
        <div class="banner-img banner-no-js">
          <a title="Accéder à la fiche technique du film Captain america : Civil War" href="/movies/271110-captain-america-civil-war">
            <img width="100%" height="auto" src="img/banner-civilwar.png" alt="Affiche du film Captain America : Civil War" />
          </a>
        </div>
        <div class="banner-img banner-no-js">
          <a title="Accéder à la fiche technique du film Le livre de la jungle" href="/movies/278927-le-livre-de-la-jungle">
            <img width="100%" height="auto" src="img/banner-jungle.png" alt="Affiche du film Le livre de la jungle" />
          </a>
        </div>
        <div class="banner-img banner-no-js">
          <a title="Accéder à la fiche technique du film X-men : apocalypse" href="/movies/246655-x-men-apocalypse">
            <img width="100%" height="auto" src="img/banner-xmen.png" alt="Affiche du film X-men : apocalypse" />
          </a>
        </div>
      </div>
    ...
    <section class="proposal">
      <div class="container">
        <div class="proposal col-md-4 col-sm-12">
          <img width="auto" height="auto" src="img/cinema.png" alt="icône pour les films actuellement au cinéma" />
                ...
                <li>
                  <div class="proposal-image">
                    <a href="/movies/{{ $value['id'] }}" title="{{ $value['title'] }}">
                      <img width="auto" height="auto" src="https://image.tmdb.org/t/p/w185/{{ $value['poster_path'] }}" alt="affiche du film {{ $value['title'] }}"/>
                    </a>
                    <div class="overlay">
                      <a title="{{ $value['title'] }}" href="/movies/{{ $value['id'] }}-{{ str_slug( $value['title'], '-') }}">
                        <img width="auto" height="auto" src="img/more.png" alt="Image pour en savoir davantage sur le film {{ $value['title'] }}" />
                      </a>
                    </div>
                  </div>
        ...
        <div class="proposal middle col-md-4 col-sm-12">
          <img width="auto" height="auto" src="img/rank.png" alt="icône pour les films les plus notés" />
        ...
        <div class="proposal col-md-4 col-sm-12">
          <img width="auto" height="auto" src="img/top.png" alt="icône pour les films les plus populaires en 2016" />
