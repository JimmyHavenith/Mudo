      ...
      <div class="movie-container container">
            ...
            <div class="movie-poster">
              <div class="movie-poster-img">
                <div class="poster-img">
                  ...
                  @else
                    <img class="profil_actor" src="../img/not-available.png" alt="photo de profil de l'acteur non disponible" title="{{ $person['name'] }}">
                  @endif
                </div>
              </div>
              <div class="poster-title title-person">
                <h2>{{ $person['name'] }}</h2>
              </div>
            </div>
          </div>
        ...
        <div class="movie-details col-md-9 col-sm-12">
          ...
          <div class="movies_actor col-md-12 col-sm-12 col-xs-12">
            <span class="item-light">Vous l'avez peut-être vu dans :</span>
            <ul>
              @foreach($credits['cast'] as $key => $value)
                @if($key < 4)
                  <li class="col-md-3 col-sm-3 col-xs-4">
                    <div class="proposal-image actor-movie-todo">
